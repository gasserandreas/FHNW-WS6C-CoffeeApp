//
//  SelectUserOnBoardingTableViewController.swift
//  FHNW-WS6C-CoffeeApp
//
...
protocol SelectUserOnBoardingTableViewControllerDelegate {
    func customDidSelectRowAt(sender: SelectUserOnBoardingTableViewController)
}

class SelectUserOnBoardingTableViewController: UITableViewController, SelectUserTableViewControllerCellDelegateMethods {
    ...
    var delegate: SelectUserOnBoardingTableViewControllerDelegate?
    ...
    func customDidSelectRowAt() {
        delegate?.customDidSelectRowAt(sender: self)
    }
